...
# ########################## NETWORK ##############################
###################################################################
class BASE3_NOCLA(nn.Module):
    def __init__(self, backbone_path=None):
        super(BASE3_NOCLA, self).__init__()
    ...
    def forward(self, x):
        ...
        layer4_feature = self.up_4(conv_4)
        layer3_feature = self.up_3(conv_3)
        layer2_feature = self.up_2(conv_2)
        layer1_feature = self.up_1(conv_1)
