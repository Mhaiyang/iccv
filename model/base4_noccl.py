...
# ########################## NETWORK ##############################
###################################################################
class BASE4_NOCCL(nn.Module):
    def __init__(self, backbone_path=None):
        super(BASE4_NOCCL, self).__init__()
    ...
    def forward(self, x):
        ...
        layer4_fusion = self.layer4_fusion(layer4_sc)

        layer3_sc = self.sc_3(layer3)
        layer3_fusion = self.layer3_fusion(layer3_sc)

        layer2_sc = self.sc_2(layer2)
        layer2_fusion = self.layer2_fusion(layer2_sc)

        layer1_sc = self.sc_1(layer1)
        layer1_fusion = self.layer1_fusion(layer1_sc)
