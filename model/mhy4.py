...
class IS(nn.Module):
    def __init__(self, planes):
        ...
        self.selectivity = Selectivity(planes)
...
class Selectivity(nn.Module):
    def __init__(self, planes, rate1=3, rate2=5):
        ...
        self.local_1a = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=1, stride=1, padding=0, dilation=1)
        self.local_1b = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=3, stride=1, padding=1, dilation=1)
        self.context_1a = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=3, stride=1, padding=rate1, dilation=rate1)
        self.context_1b = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=3, stride=1, padding=rate2, dilation=rate2)

        self.local_2a = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=1, stride=1, padding=0, dilation=1)
        self.local_2b = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=3, stride=1, padding=1, dilation=1)
        self.context_2a = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=3, stride=1, padding=rate1, dilation=rate1)
        self.context_2b = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=3, stride=1, padding=rate2, dilation=rate2)

        self.local_3a = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=1, stride=1, padding=0, dilation=1)
        self.local_3b = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=3, stride=1, padding=1, dilation=1)
        self.context_3a = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=3, stride=1, padding=rate1, dilation=rate1)
        self.context_3b = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=3, stride=1, padding=rate2, dilation=rate2)

        self.local_4a = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=1, stride=1, padding=0, dilation=1)
        self.local_4b = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=3, stride=1, padding=1, dilation=1)
        self.context_4a = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=3, stride=1, padding=rate1, dilation=rate1)
        self.context_4b = nn.Conv2d(self.outplanes, self.outplanes, kernel_size=3, stride=1, padding=rate2, dilation=rate2)
    ...
    def forward(self, x):
        ...
        local_1 = self.local_1a(y) + self.local_1b(y)
        context_1 = self.context_1a(y) + self.context_1b(y)
...
# ########################## NETWORK ##############################
###################################################################
class MHY4(nn.Module):
    def __init__(self, backbone_path=None):
        super(MHY4, self).__init__()
