...
class OUR1(nn.Module):
    def __init__(self, backbone_path=None):
        ...
        self.conv_4 = nn.Sequential(nn.Conv2d(2048, 2048, 3, 1, 1), nn.BatchNorm2d(2048), nn.ReLU())
        self.conv_3 = nn.Sequential(nn.Conv2d(1024, 1024, 3, 1, 1), nn.BatchNorm2d(1024), nn.ReLU())
        self.conv_2 = nn.Sequential(nn.Conv2d(512, 512, 3, 1, 1), nn.BatchNorm2d(512), nn.ReLU())
        self.conv_1 = nn.Sequential(nn.Conv2d(256, 256, 3, 1, 1), nn.BatchNorm2d(256), nn.ReLU())
    ...
    def forward(self, x):
        ...
        contrast_4 = self.contrast_4(conv_4)
        contrast_3 = self.contrast_3(conv_3)
        contrast_2 = self.contrast_2(conv_2)
        contrast_1 = self.contrast_1(conv_1)
