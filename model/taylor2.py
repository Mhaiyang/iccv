...
# ########################## NETWORK ##############################
###################################################################
class TAYLOR2(nn.Module):
    def __init__(self, backbone_path=None):
        super(TAYLOR2, self).__init__()
        ...
        self.edge_predict = nn.Sequential(nn.Conv2d(256, 64, 3, 1, 1), nn.BatchNorm2d(64), nn.ReLU(),
    ...
    def forward(self, x):
        ...
        layer4_map = F.sigmoid(F.avg_pool2d(layer4_predict, (4, 4), stride=(4, 4)))
        ...
        layer3_map = F.sigmoid(F.avg_pool2d(layer3_predict, (2, 2), stride=(2, 2)))
        ...
        edge_predict = self.edge_predict(contrast_1)
