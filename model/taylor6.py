...
# ########################## NETWORK ##############################
###################################################################
class TAYLOR6(nn.Module):
    def __init__(self, backbone_path=None):
        super(TAYLOR6, self).__init__()
        ...
        self.edge_predict = nn.Sequential(nn.Conv2d(64, 8, 3, 1, 1), nn.BatchNorm2d(8), nn.ReLU(),
                                          nn.Conv2d(8, 1, 3, 1, 1))
    ...
    def forward(self, x):
        ...
        edge_predict = self.edge_predict(up_1)
